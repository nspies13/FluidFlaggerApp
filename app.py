...
from src.theme import _THEME
from src.ui import _CSS
...
app = gr.mount_gradio_app(fastapi_app, demo, path="/", ssr_mode=False, theme=_THEME, css=_CSS)

if __name__ == "__main__":
    demo.launch(server_port=7860, server_name="0.0.0.0", theme=_THEME, css=_CSS)
